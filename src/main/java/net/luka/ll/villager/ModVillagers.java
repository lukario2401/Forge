...
public class ModVillagers {
    ...
    public static final RegistryObject<PoiType> STALINIUM_BLOCK_POI = POI_TYPES.register("stalinium_block_poi", () ->
            new PoiType(ImmutableSet.copyOf(ModBlocks.STALINIUM_BLOCK.get().getStateDefinition().getPossibleStates()), 1, 1));
    ...
    public static final RegistryObject<VillagerProfession> STALINIUM_TRADER = VILLAGER_PROFESSION.register("stalinium_trader", () ->
            new VillagerProfession("stalinium_trader", x -> x.get() == STALINIUM_BLOCK_POI.get(),
                    x -> x.get() == STALINIUM_BLOCK_POI.get(), ImmutableSet.of(), ImmutableSet.of(),  SoundEvents.VILLAGER_WORK_ARMORER));
    ...
    public static void registerPOIs() {
        try {
            ...
            ObfuscationReflectionHelper.findMethod(PoiType.class, "registerBlockStates", PoiType.class).invoke(null, STALINIUM_BLOCK_POI.get());
